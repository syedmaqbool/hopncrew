...
const styles = StyleSheet.create({
  ...
  h2: { color: '#111', marginTop: 6, fontFamily: FONTS.bold },
  body: { color: '#3C3C43', marginTop: 8, lineHeight: 20, fontFamily: FONTS.regular },
  ...
  impTitle: { color: '#111', fontFamily: FONTS.bold },
  impBody: { color: '#111', marginTop: 6, lineHeight: 18, fontFamily: FONTS.regular },
  ...
  disclaimerTitle: { color: '#0B3D3B', fontFamily: FONTS.bold },
  liRow: { flexDirection: 'row', gap: 8 },
  bullet: { color: '#0B3D3B', fontSize: 18, lineHeight: 20 },
  liText: { flex: 1, color: '#0B3D3B', lineHeight: 18, fontFamily: FONTS.regular },
  ...
  okayTxt: { color: '#fff', fontFamily: FONTS.bold },
  cancelBtn: {
    flex: 1,
    height: 46,
    borderRadius: 24,
  ...
  cancelTxt: { color: '#111', fontFamily: FONTS.bold },
});
