...
const styles = StyleSheet.create({
  ...
  infoTitle: { color: '#111', fontFamily: FONTS.bold },
  infoSub: { color: '#666', marginTop: 2, fontFamily: FONTS.regular },
  ...
  toggleTxt: { color: '#111', fontSize: 12, flexShrink: 1, fontFamily: FONTS.medium },
  infoCircle: {
    width: 20,
    height: 20,
    borderRadius: 10,
