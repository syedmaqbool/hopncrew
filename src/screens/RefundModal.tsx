...
const MINT = '#B9FBE7';
const SHEET_RATIO = 0.7; // 70% of current window height
...
const styles = StyleSheet.create({
  ...
  body: { color: '#23272F', marginTop: 12, lineHeight: 20, fontFamily: FONTS.regular },
  ...
  calloutSub: { color: '#0B3D3B', opacity: 0.85, marginTop: 6, fontFamily: FONTS.regular },

  item: { color: '#111', marginTop: 8, lineHeight: 20, fontFamily: FONTS.regular },
  bullet: { color: '#111', marginTop: 6, lineHeight: 20, fontFamily: FONTS.regular },
