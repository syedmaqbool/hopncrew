...
const styles = StyleSheet.create({
 ...
 backdrop: {
  ...
  sub: { color: '#6C7075', marginTop: 2, fontFamily: 'BiennaleSemiBold' },
  eta: {
    width: 74, height: 74, borderRadius: 12,
    backgroundColor: '#111', alignItems: 'center', justifyContent: 'center',
  },
  etaNum: { color: '#fff', fontSize: 28, fontFamily: 'BiennaleBold' },
  etaMin: { color: '#fff', fontFamily: 'BiennaleRegular' },
  ...
  chipDarkTxt: { color: '#fff', fontFamily: 'BiennaleBold' },
  ...
  chipTxt: { color: '#6C7075', fontFamily: 'BiennaleBold' },
  ...
  driverMeta: { color: '#6C7075', fontSize: 12, marginTop: 2, fontFamily: 'BiennaleRegular' },
  verifiedRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  verifiedTxt: { color: '#111', marginLeft: 6, fontFamily: 'BiennaleSemiBold' },
  ...
  plateTxt: { color: '#111', fontSize: 12, fontFamily: 'BiennaleBold' },
  ...
  actionTxt: { color: '#111', fontFamily: 'BiennaleBold' },
});
