...
const styles = StyleSheet.create({
 ...
 backdrop: {
  ...
  chipDarkTxt: { color: '#fff', fontFamily: FONTS.bold },
  ...
  chipTxt: { color: '#6C7075', fontFamily: FONTS.bold },
  ...
  driverMeta: { color: '#6C7075', fontSize: 12, marginTop: 2, fontFamily: FONTS.regular },
  verifiedRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  verifiedTxt: { color: '#111', marginLeft: 6, fontFamily: FONTS.semibold },
  ...
  plateTxt: { color: '#111', fontSize: 12, fontFamily: FONTS.bold },
