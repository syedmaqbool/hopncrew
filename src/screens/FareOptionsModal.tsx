                ...
                <Pressable
                  onPress={() => {
                    navigation.navigate('Policies', {
                      onSelect: id =>
                        console.log('open policy details for', id),
                    });
                  }}
                >
  ...
  return (
    ...
    >
      ...
      <View style={styles.priceSlab}>
        ...
        {!!quote.oldPrice && (
          <Text style={styles.priceOld}>${quote.oldPrice}</Text>
        )}
      </View>
...
//   // pickup & drop from params (fallback to YYZ -> sample)
//   const start: Destination = route.params?.start ?? {
//     description: 'Pickup',
//     latitude: 43.6777,
//     longitude: -79.6248,
//   };
//   const dest: Destination = route.params?.dest ?? {
...
//   // a fake mid-point for car marker
//   const car = useMemo(() => {
//     const lat = (start.latitude + dest.latitude) / 2;
//     const lng = (start.longitude + dest.longitude) / 2;
...
//   return (
//     <View style={styles.fill}>
//       {/* Header Map with rounded bottom */}
...
//             <Image
//               source={assets.images.carMarker /* your car icon */}
...
//         {/* overlay top (back + ETA pill) */}
//         <SafeAreaView
//           style={[styles.overlayTop, { paddingTop: insets.top + 6 }]}
//         >
//           <Pressable
//             style={styles.roundBtn}
//             onPress={() => navigation.goBack()}
...
//             >
//               {['Waiting Time', 'No-Show Policy'].map(p => (
//                 <View key={p} style={styles.chip}>
//                   <Text style={styles.chipTxt}>{p}</Text>
//                 </View>
//               ))}
...
//       style={[
//         styles.card,
//         selected && { borderColor: '#111', backgroundColor: '#FFFFFF' },
//       ]}
//     >
//       {/* left price slab */}
//       <View style={styles.priceSlab}>
...
// const styles = StyleSheet.create({
//   fill: { flex: 1, backgroundColor: '#F2F3F4' },
...
//     minWidth: 88,
//   },
//   priceNow: { color: '#000', fontSize: 26, fontWeight: '800' },
//   priceOld: {
//     color: '#6B7280',
...
//   dotLabel: { color: '#111', fontWeight: '700', maxWidth: 120 },
// });
