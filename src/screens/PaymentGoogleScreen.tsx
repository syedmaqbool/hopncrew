...
type Props = NativeStackScreenProps<RootStackParamList, 'PaymentGoogle'>;

export default function PaymentGoogleScreen({ navigation, route }: Props) {
    ...
    <View style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.headerRow}>
          ...
          <Text style={styles.headerTitle}>Google Pay</Text>
        </View>
        ...
        <View style={styles.sheet}>
          ...
          <View style={styles.outerCard}>
            <Text style={styles.cardTitle}>
              Google Pay brings together everything you need and keep your
              payment secure.
            </Text>
...
/* same base styles as Cash + a few extras */
